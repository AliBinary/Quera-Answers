...
bool cmp(pair<int, str> &a, pair<int, str> &b) { return (a.S < b.S); }
...
void solve()
{
    ...
    V<pair<int, str>> temp = {mp(0, "keyvoon"), mp(0, "nezam"), mp(0, "shir farhad")};
    FOR(i, 0, n)
    {
        if (s1[i] == a[i % 6])
            temp[0].F++;
